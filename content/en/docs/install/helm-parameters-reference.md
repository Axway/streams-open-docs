...
| `discoveryAgent.apimanager.streamsJWTTokenAPIFrontendName` | The frontend name of the Streams JWT token API provisioned on the APIManager               | no        | Streams Subscribers SSE Auth                                 |
| `discoveryAgent.apimanager.streamsJWTTokenAPISecurityType` | The security type configured for the Streams JWT token API provisioned on the APIManager   | no        | api-key                                                      |
