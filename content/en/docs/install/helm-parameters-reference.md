...
| `discoveryAgent.apimanager.streamsJWTTokenFrontendName`    | The frontend name of the Streams JWT token provisioned on the APIManager | no        | Streams Subscribers SSE Auth                                 |
