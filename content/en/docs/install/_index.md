...
You must specify a hostname for the ingress installed with the helm Streams. You can change it thanks to `ingress.host` parameter. Throughout this documentation, we are using _k8s.yourdomain.tld_ as an example value.
